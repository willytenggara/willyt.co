...
export const blog = {
  ...
  release: true,
  readDuration: readingTime(`Hello everyone! 🙋🏻 How are you guys doing?! Hope you guys are doing well!
...
So that's a little bit of information regarding the changes of my name. Thanks for reading!`).text,
}
